...
public:
    ...
    Shader(const std::string& vertFragFilePath, class Logger* loggerRef);

    /*Constructor for shader with tesselation*/
    Shader(const std::string& vertFragFilePath, const std::string& tessFilePath, class Logger* loggerRef);
